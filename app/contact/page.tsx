                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {contactPlatforms.map((platform, index) => (
                    <a
                      ...
                      className={`group bg-gray-100 dark:bg-zinc-900/50 hover:bg-gray-200 dark:hover:bg-zinc-900/70 border border-gray-200 dark:border-zinc-800 rounded-xl p-6 transition-all duration-200 hover:border-gray-300 dark:hover:border-zinc-700 cursor-pointer`}
                    >
                      <div className="flex items-start gap-4">
                        <div className="text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                          {platform.icon}
                        </div>
                        ...
                        <svg
                          className="w-4 h-4 text-gray-400 dark:text-gray-600 group-hover:text-gray-600 dark:group-hover:text-gray-400 transition-colors"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
